...
- [ammo-material-v1 要件](ammo-material-v1.md): Issue #77の3マテリアル、7 weapon、WeaponInstance、完了時消費reload、world補給、terminal/retry境界。
- [wave-progression-v1 要件](wave-progression-v1.md): enemy-free初回準備、3 combat waveと2 rest、combat epoch、固定12 slot、phase HUD、terminal/retryの移行境界。
